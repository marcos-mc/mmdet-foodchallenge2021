...
dataset_path = r'/media/HDD_3TB_2/bhalaji/challenges/aicrowd/food_recognition_challenge/data'
train_annotations_path = os.path.join(dataset_path, 'train', 'annotations.json')
train_images_path = os.path.join(dataset_path, 'train', 'images')
val_annotations_path = os.path.join(dataset_path, 'val', 'annotations.json')
